...
# __output$newCasesRecoveredPlot ----
...
# __output$cumulativeCountryPlot ----
...
# __output$newCasesDeathCountryPlot ----
...
# __output$newCasesRecoveredCountryPlot ----
